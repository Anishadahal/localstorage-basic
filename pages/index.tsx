...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-gray-200">
      <h1 className="pt-4 text-5xl text-center">Local Storage Methods Demo</h1>
      <div className="flex flex-col items-start py-4 mx-8">
        ...
        <div>
          ...
          <span className="ml-3 mr-2 text-sm text-gray-800">Remove username key-value pair</span>
        </div>
        <div>
          <button
            onClick={handleClear}
          ...
          <span className="ml-3 mr-2 text-sm text-gray-800">Clear everything in localStorage</span>
        </div>
      </div>
      <div className="items-start justify-between flex-1 h-screen mx-auto mt-6">
        ...
        <div className="py-4 ml-8">
          ...
          <div>
            ...
            <p className="p-2 text-sm">
              UserData: <span className="text-gray-800">{JSON.stringify(userData)}</span>
            </p>
            <p className="p-2 text-sm">
              List of Keys: <span className="text-gray-800">{keys.join(", ")}</span>
            </p>
            <p className="p-2 text-sm">
              Total Items in Local Storage: <span className="text-gray-800">{length}</span>
            </p>
          </div>
        </div>
      </div>
